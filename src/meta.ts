...
export const LEGACY_UPGRADES: LegacyUpgrade[] = [
  ...
  { id: "reward_choice_2", name: "広まる武勇伝", icon: "📣", cost: 58, desc: "通常戦闘後のユニット候補がさらに +1", requires: "reward_choice" },
  { id: "reward_reroll", name: "運命の選び直し", icon: "🎲", cost: 48, desc: "通常戦闘後のユニット候補を1回リロールできる", requires: "reward_choice" },
  { id: "ancient_reroll", name: "古代の再託宣", icon: "🔮", cost: 70, desc: "幕ボス撃破後のエンシェントレリック候補を1回リロールできる" },
  { id: "team_cap_1", name: "英雄の号令 I", icon: "🚩", cost: 55, desc: "配置上限 +1" },
  { id: "team_cap_2", name: "英雄の号令 II", icon: "🚩", cost: 85, desc: "配置上限がさらに +1", requires: "team_cap_1" },
