...
export const ASC_LEVELS: AscLevel[] = [
  ...
  { debuff: "敵攻撃力 +10%", buff: "勝利ゴールド +2", e: { enemyAtkPct: 10, winGold: 2 } },
  {
    ...
    milestone: true,
    e: { enemyArmor: 15, interest: true },
  },
  { debuff: "敗北ダメージ +3", buff: "開始HP +5", e: { loseDamage: 3, startHp: 5 } },
  { debuff: "敵HP +10%", buff: "アイテムドロップ率 +10%", e: { enemyHpPct: 10, itemDropPct: 10 } },
  { debuff: "敵攻撃速度 +7%", buff: "開始ゴールド +5", e: { enemyAsPct: 7, startGold: 5 } },
  { debuff: "休憩の回復量が半分", buff: "開始時アイテム1個", e: { restHalf: true, startItems: 1 } },
  {
    debuff: "ボスHP +25%",
    buff: "【英雄の器】配置上限 +1",
    milestone: true,
    e: { bossHpPct: 25, capBonus: 1 },
  },
  { debuff: "ショップ価格 +1G", buff: "勝利ゴールド +2", e: { shopMarkup: 1, winGold: 2 } },
  { debuff: "敵HP +10%", buff: "アイテムドロップ率 +10%", e: { enemyHpPct: 10, itemDropPct: 10 } },
  { debuff: "敵攻撃力 +10%", buff: "開始HP +5", e: { enemyAtkPct: 10, startHp: 5 } },
  { debuff: "敗北ダメージ +4", buff: "開始ゴールド +5", e: { loseDamage: 4, startGold: 5 } },
  {
    debuff: "敵HP +15%、最大HP -7",
    buff: "【始まりの遺物】ラン開始時にレリックを3択から選ぶ",
    milestone: true,
    e: { enemyHpPct: 15, maxHpLoss: 7, relicPick: true },
  },
];
