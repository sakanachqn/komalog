...
export const RELICS: RelicDef[] = [
  ...
  { id: "emberCharm", name: "火種の護符", icon: "🔥", desc: "各味方が最初に発動するスキルのダメージ・回復・シールド量 +20%" },
  { id: "hunterMonocle", name: "狩人の片眼鏡", icon: "🧐", desc: "最大HPが最も高い敵に与えるダメージ +15%" },
  { id: "silverVial", name: "聖銀の小瓶", icon: "🧴", desc: "味方が与える回復量とシールド量 +18%" },
  { id: "pursuitSpur", name: "追撃の拍車", icon: "🥾", desc: "敵を倒したユニットは戦闘終了まで攻撃速度 +12%（最大3回）" },
  { id: "mossArmor", name: "苔むした甲冑", icon: "🪨", desc: "射程1の味方は防御 +15、最大HP +10%" },
  { id: "farLens", name: "遠見のレンズ", icon: "🔭", desc: "射程3以上の味方は攻撃力・呪文威力 +15%" },
  { id: "duelistMark", name: "決闘者の印", icon: "🎯", desc: "初期配置で周囲1マスに味方がいないユニットは与ダメージ +18%" },
  { id: "guidingLamp", name: "導きの灯火", icon: "🕯️", desc: "戦闘開始時、最もマナの低い味方3体のマナ +15" },
  { id: "luckyCoin", name: "商人の幸運貨", icon: "🪙", desc: "ショップのユニットリロール費用 -1G（最低1G）" },
  { id: "victoryPurse", name: "戦勝の財布", icon: "💰", desc: "3戦勝利するたびに追加で8G獲得" },
  { id: "salvageMagnet", name: "回収者の磁石", icon: "🧲", desc: "装備中の味方が生存して勝利すると、次戦のアイテムドロップ率 +8%（最大24%）" },
  { id: "noviceStardust", name: "未熟者の星屑", icon: "⭐", desc: "★1ユニットの最大HP・攻撃力・呪文威力 +15%" },
  { id: "veteranBadge", name: "古参兵の徽章", icon: "🎖️", desc: "★2以上のユニットの防御 +12、クリティカル率 +10%" },
  { id: "bloodthornRing", name: "血棘の指輪", icon: "🌹", desc: "味方が通常攻撃を受けると、攻撃者へ受けたダメージの15%を反射" },
  { id: "phoenixFeather", name: "不死鳥の羽根", icon: "🪶", desc: "各戦闘で最初に倒れた味方1体が最大HP20%・マナ0で一度だけ復活" },
  { id: "chainRosary", name: "連鎖の数珠", icon: "📿", desc: "味方がスキルを合計5回発動するたび、味方全体のマナ +8" },
  { id: "openingBell", name: "開戦の鐘", icon: "🔔", desc: "戦闘開始から5秒間、味方全体の攻撃速度 +20%" },
  { id: "executionWrit", name: "処刑執行状", icon: "📜", desc: "HP20%以下の敵に与えるダメージ +25%" },
  { id: "manaEye", name: "魔力吸収の瞳", icon: "🧿", desc: "敵がスキルを発動するたび、味方全体のマナ +2" },
  { id: "guardianChain", name: "守護の鎖", icon: "🔗", desc: "味方がスキルを発動すると、隣接する味方へ発動者の最大HP5%のシールド" },
  { id: "poisonWhetstone", name: "毒塗りの砥石", icon: "🦂", desc: "各味方は通常攻撃4回ごとに攻撃力60%の防御無視ダメージを追加" },
  { id: "critScope", name: "会心の照準器", icon: "🔍", desc: "味方全体のクリティカルダメージ +30%" },
  { id: "rearOath", name: "後衛の誓約", icon: "🏹", desc: "最後列で最も攻撃性能が高い味方1体の攻撃力・呪文威力 +20%" },
  { id: "balanceCrest", name: "均衡の紋章", icon: "⚖️", desc: "異なるシナジーが3種類以上発動中なら、味方全体の最大HP・攻撃力 +10%" },
  { id: "discountTag", name: "商会の割引札", icon: "🏷️", desc: "ショップのアイテム価格 -2G、レリック価格 -3G（最低1G）" },
  { id: "campKit", name: "上等な野営道具", icon: "🏕️", desc: "休憩マスのHP回復量 +5。休憩時にプレイヤー最大HP +1" },
];
