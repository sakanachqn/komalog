...
export const ITEMS: ItemDef[] = [
  { id: "sword", name: "剛剣", icon: "🪒", desc: "攻撃力 +30%" },
  { id: "shield", name: "大盾", icon: "🔰", desc: "防御 +30" },
  ...
  { id: "crystal2", name: "無限の水晶", icon: "🔷", desc: "開幕マナ全開。最初のスキルを50%威力でもう一度発動", tier: 2 },
  ...
  { id: "sword_bow", name: "双撃の刃", icon: "🥋", desc: "攻撃力+25%、攻撃速度+20%。通常攻撃4回ごとに追加攻撃", tier: 2 },
  { id: "sword_orb", name: "巨獣殺し", icon: "🐘", desc: "攻撃力+25%、最大HP+250。自身より最大HPが高い敵へ+20%ダメージ", tier: 2 },
  ...
  { id: "sword_claw", name: "首狩りの刃", icon: "🦅", desc: "攻撃力+25%、クリ率+25%、クリダメ+25%", tier: 2 },
  ...
  { id: "staff_orb", name: "生命の杖", icon: "☘️", desc: "呪文威力+40%、最大HP+300。回復・シールド量+30%", tier: 2 },
  { id: "staff_blade", name: "魂喰らいの杖", icon: "👁️", desc: "呪文威力+45%。スキルダメージの20%を吸収", tier: 2 },
  ...
  { id: "bow_orb", name: "森羅の弓", icon: "🏞️", desc: "攻撃速度+25%、最大HP+250。通常攻撃5回ごとに最大HP5%回復", tier: 2 },
  ...
  { id: "blade_crystal", name: "血晶の刃", icon: "💉", desc: "吸血20%、初期マナ+35。スキル発動時に最大HP8%回復", tier: 2 },
